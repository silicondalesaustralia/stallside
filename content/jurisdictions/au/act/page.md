...
| | |
|---|---|
| **Gate** | Food business registration under the Food Act 2001 (ACT) |
| **Who you deal with** | ACT Health Protection Service (regulator); Access Canberra (application portal) |
| **Registration fee** | Risk-based. Low risk, 1 year: A$163. Medium: A$239.50. High: A$321.55. Two- and three-year terms also published |
| **When** | Before opening |
| **Inspection** | Premises inspected by ACT Health before registration is granted |
| **Sales cap** | None under the ACT registration system |
| **Approved food list** | No cottage-food style list. Home kitchens are limited to low-risk preparation |
| **Food Safety Supervisor** | Required for registered food businesses, with some non-profit exemptions |
...
| Length | Low risk | Medium risk | High risk |
|---|---|---|---|
| 1 year | A$163.00 | A$239.50 | A$321.55 |
| 2 years | A$326.00 | A$479.00 | A$643.10 |
| 3 years | A$489.00 | A$718.50 | A$964.65 |
...
* [Selling food from a home-based business](https://www.act.gov.au/business/health-licenses-and-inspections/food-businesses-and-events-registration/selling-food-from-a-home-based-business) (ACT Government)
