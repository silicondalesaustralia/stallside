...
| | |
|---|---|
| **Gate** | Food Business Notification |
| **Who you notify** | Usually your local council |
| **Notification fee** | Nil |
| **When** | Before you start operating |
| **General food-business licence** | No. Notification is the main state food-business gate |
| **Sales cap** | None under the SA notification system |
| **Approved food list** | None. The Food Standards Code applies according to the food and activity |
| **Multiple premises** | Separate notification is required for each site |
...
If you want customers to scan a QR code, select what they are buying, pay and update your stall inventory without someone being there, [see how Vendl handles farm-stand checkout and pre-orders](/stall).
