...
export const ordersAlertsBillingArticles: KnowledgeArticle[] = [
  ...
  },
  {
    ...
    summary:
      "Trial, subscribe, cancel, and what happens when access lapses.",
    videoUrl: null,
    related: ["customer-payments", "first-stand"],
    ctas: [{ label: "Billing", href: "/dashboard/settings/billing" }],
    steps: [
      "Stallside’s subscription is what you pay for the app (stands, products, orders, QR). It is separate from customer card payments at the stand.",
      "New owners get a 30-day free trial with every Card plan feature — Tap & Go, pre-orders, collections, restock emails, branding, and more. No card required to start.",
      "Home may show days left on your free trial. When the trial ends, the dashboard locks until you subscribe to Cash or Card. Your stands and history stay saved.",
      "Open Settings → Manage subscription (or Billing) to pick currency and subscribe with Stripe.",
      "To update a card or cancel a paid plan, use Manage payment method / cancel (Stripe Customer Portal).",
      "If you cancel a paid plan, you usually keep access until the paid period ends. Your stands and history stay saved.",
      "On a free trial with no card on file, nothing will charge when the trial ends — you can simply stop using Stallside, or use Settings → Delete account to wipe your data and stop emails.",
      "Delete account (Settings) immediately cancels any Stallside subscription, stops emails, permanently removes your stands, products, and order history, and sends a short goodbye email asking for feedback.",
      "When access ends without deleting, stands, products, inventory, and orders lock. You can still open Billing and Guides to resubscribe — data is not deleted until you delete the account.",
  ...
  },
  {
    ...
    steps: [
      ...
      "You need an active free trial or the Card plan (Settings → Billing) before Stripe Connect is available.",
      ...
      "PayPal at checkout is coming soon. Cash and PayID (Australia only) still work without Stripe.",
    ],
  },
];
