...
export default function LpObjections({
  heading = "Made for the way honesty stalls already work",
  support = "Vendl does not replace the trust behind your stall. It gives honest customers more ways to pay and gives you a clearer record of what was taken.",
