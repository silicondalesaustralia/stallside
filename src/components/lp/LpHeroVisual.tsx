...
export default function LpHeroVisual() {
  return (
    <div className="relative mx-auto w-full max-w-md lg:max-w-lg">
      ...
      <div className="mt-3 flex flex-wrap gap-2 sm:absolute sm:-left-3 sm:top-6 sm:mt-0 sm:max-w-[11rem] sm:flex-col lg:-left-6">
      ...
      <div className="mt-3 sm:absolute sm:-right-2 sm:bottom-16 sm:mt-0 sm:max-w-[12.5rem] lg:-right-4">
        <LpUpsellOfferBadge
          title="Add a jar of honey?"
          compareAt="A$9.00"
          price="A$7.00"
        />
      </div>
