      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-4">
        <div className="rounded-[var(--radius)] border-2 border-[var(--leaf)] bg-[var(--panel)] p-[var(--pad-lg)]">
          ...
          <p className="mt-4 text-sm text-[var(--muted)]">
            Take cash and PayID bank transfers (Australia only). Track stock. Print QR posters. Sale and
            low-stock alerts.
          </p>
          <p className="mt-2 text-sm text-[var(--muted)]">
            PayID (Australia only) lands in your account with no fee. Set up in two minutes.
          </p>
          <Link
            href="/signup"
